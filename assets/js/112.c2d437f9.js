...
/* harmony export */   e: () => (/* binding */ innerInsertMultiple),
/* harmony export */   insert: () => (/* binding */ insert),
/* harmony export */   insertMultiple: () => (/* binding */ insertMultiple)
/* harmony export */ });
/* harmony import */ var _components_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3283);
...
async function innerInsert(orama, doc, language, skipHooks) {
    ...
    for (const [key, value] of Object.entries(indexableValues)){
        ...
        if ((0,_components_js__WEBPACK_IMPORTED_MODULE_0__/* .isGeoPointType */ .gf)(expectedType) && typeof value === 'object' && typeof value.lon === 'number' && typeof value.lat === 'number') {
            continue;
        }
        if ((0,_components_js__WEBPACK_IMPORTED_MODULE_0__/* .isVectorType */ .AA)(expectedType) && Array.isArray(value)) {
            continue;
        }
        if ((0,_components_js__WEBPACK_IMPORTED_MODULE_0__/* .isArrayType */ ._L)(expectedType) && Array.isArray(value)) {
            continue;
        }
    ...
    (0,_components_sync_blocking_checker_js__WEBPACK_IMPORTED_MODULE_2__/* .trackInsertion */ .v)(orama);
    return id;
}
...
/* harmony import */ var _components_internal_document_id_store_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7348);
/* harmony import */ var _components_sync_blocking_checker_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7561);
...
async function remove(orama, id, language, skipHooks) {
    ...
    const docId = (0,_components_internal_document_id_store_js__WEBPACK_IMPORTED_MODULE_1__/* .getDocumentIdFromInternalId */ .f8)(orama.internalDocumentIDStore, (0,_components_internal_document_id_store_js__WEBPACK_IMPORTED_MODULE_1__/* .getInternalDocumentId */ .Kj)(orama.internalDocumentIDStore, id));
    const docsCount = await orama.documentsStore.count(docs);
    if (!skipHooks) {
        await (0,_components_hooks_js__WEBPACK_IMPORTED_MODULE_0__/* .runSingleHook */ .VK)(orama.beforeRemove, orama, docId);
    }
    const indexableProperties = await orama.index.getSearchableProperties(index);
    const indexablePropertiesWithTypes = await orama.index.getSearchablePropertiesWithTypes(index);
    ...
    if (!skipHooks) {
        await (0,_components_hooks_js__WEBPACK_IMPORTED_MODULE_0__/* .runSingleHook */ .VK)(orama.afterRemove, orama, docId);
    }
...
async function removeMultiple(orama, ids, batchSize, language, skipHooks) {
    ...
    const docIdsForHooks = skipHooks ? [] : ids.map((id)=>(0,_components_internal_document_id_store_js__WEBPACK_IMPORTED_MODULE_1__/* .getDocumentIdFromInternalId */ .f8)(orama.internalDocumentIDStore, (0,_components_internal_document_id_store_js__WEBPACK_IMPORTED_MODULE_1__/* .getInternalDocumentId */ .Kj)(orama.internalDocumentIDStore, id)));
    if (!skipHooks) {
        await (0,_components_hooks_js__WEBPACK_IMPORTED_MODULE_0__/* .runMultipleHook */ .F_)(orama.beforeRemoveMultiple, orama, docIdsForHooks);
    }
    await new Promise((resolve, reject)=>{
        let i = 0;
        async function _insertMultiple() {
    ...
    if (!skipHooks) {
        await (0,_components_hooks_js__WEBPACK_IMPORTED_MODULE_0__/* .runMultipleHook */ .F_)(orama.afterRemoveMultiple, orama, docIdsForHooks);
    }
    return result;
}
...
/* harmony import */ var _remove_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3513);
...
async function updateMultiple(orama, ids, docs, batchSize, language, skipHooks) {
    ...
    const newIds = await (0,_insert_js__WEBPACK_IMPORTED_MODULE_2__/* .innerInsertMultiple */ .e)(orama, docs, batchSize, language, skipHooks);
    if (!skipHooks) {
