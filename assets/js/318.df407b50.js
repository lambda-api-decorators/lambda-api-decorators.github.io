...
function innerCreate(orama, sharedInternalDocumentStore, schema, sortableDeniedProperties, prefix) {
    ...
    for (const [prop, type] of Object.entries(schema)){
        ...
        if (!(0,defaults/* isVectorType */.AA)(type)) {
            switch(type){
                case 'boolean':
                case 'number':
                case 'string':
...
// UNUSED EXPORTS: calculateResultScores, insertDocumentScoreParameters, insertTokenScoreParameters, removeDocumentScoreParameters, removeTokenScoreParameters
    ...
    for (const [prop, type] of Object.entries(schema)){
        ...
        if ((0,defaults/* isVectorType */.AA)(type)) {
            ...
            index.vectorIndexes[path] = {
                size: (0,defaults/* getVectorSize */.DN)(type),
                vectors: {}
            };
        } else {
...
async function components_insert(implementation, index, prop, id, value, schemaType, language, tokenizer, docsCount) {
    if ((0,defaults/* isVectorType */.AA)(schemaType)) {
    ...
    if (!(0,defaults/* isArrayType */._L)(schemaType)) {
...
async function components_remove(implementation, index, prop, id, value, schemaType, language, tokenizer, docsCount) {
    ...
    const innerSchemaType = (0,defaults/* getInnerType */.TL)(schemaType);
    const elements = value;
    const elementsLength = elements.length;
    for(let i = 0; i < elementsLength; i++){
